...
function ContactDev() {
    ...
    return (
        <div className="dashboard-container">
            <Sidebar/>
            <div
                className={`sent-message ${isMessageSent ? "message-sent-show" : "message-sent-hide"}`}
            >
                <span>
                    ...
                    <div className="contact-form-row">
                        <div className="contact-form-element">
                            ...
                            <input type="text"
                                ...
                                className={`contact-form-text ${nameError ? "contact-element-error" : ""}`}
                                required
                            />
                        </div>
                        ...
                        <div className="contact-form-element">
                            ...
                            <input type="text"
                                ...
                                spellCheck="false"
                                className={`contact-form-text ${emailError ? "contact-element-error" : ""}`}
                                required
                            />
                        </div>
                    </div>
                    <br />
                    <div className={`textarea-container ${textareaError ? "contact-element-error" : ""}`}>
                        <textarea
