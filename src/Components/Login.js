    ...
    validateForm().then((errors) => {
      if (errors.userError || errors.passwordError) {
        ...
        loginButtonRef.current.innerHTML =
          'Signing in.. <i class="fal fa-spinner fa-spin"></i>';
        axios
          .post("https://shattapp-api.onrender.com/user/login", {
            username: userName,
            password: password,
          })
          .then((res) => {
      ...
      <div className="login-content-container">
        <div className="login-content">
          ...
          <form action="#" id="login-form">
            ...
            <button
              className={`bg-dark text-light form-btn c_pointer ${
